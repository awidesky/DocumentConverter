...
public class MainFrame extends JFrame {
	...
	public void init() {
		...
		try {
			System.out.println(JarPath.getProjectPath(MainFrame.class));
			BufferedImage ICON = ImageIO.read(new File(JarPath.getProjectPath(MainFrame.class) + "/icon/icon.png"));
			setIconImage(ICON);
